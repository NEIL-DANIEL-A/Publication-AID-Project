...
def build_hash_input(
    ...
    scopus_issn: str = "",
    scopus_eissn: str = "",
    scopus_raw_active: str = "",
    scopus_raw_discontinued: str = "",
    mjl_status: str = "",
    mjl_index: str = "",
    mjl_issn_used: str = "",
    mjl_match_type: str = "",
    ...
    return {
        ...
        "scopus_raw_active": scopus_raw_active,
        "scopus_raw_discontinued": scopus_raw_discontinued,
        "mjl_status": mjl_status,
        "mjl_index": mjl_index,
        "mjl_issn_used": mjl_issn_used,
        "mjl_match_type": mjl_match_type,
